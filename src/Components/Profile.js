                                    ...
                                    >
                                        <div className="modal-container" style={{display:"block"}}>
                                            <div className="video-modal" >
                                                <video autoPlay={true} muted="muted" controls style={{marginLeft:"44vw"}}>
                                                    <source src={post.pUrl}/>
                                                </video>
                                            </div>
                                                ...
                                                <Card className="card1" style={{padding:'1rem'}}>
                                                    ...
                                                    <Card variant="outlined" className="card2">
                                                        <div style={{display:"flex"}}>
                                                            ...
                                                            <Typography style={{padding:'0.3rem',dispaly:"inline"}}>{post.likes.length==0?'Liked by nobody':`Liked by ${post.likes.length} users`}</Typography>
